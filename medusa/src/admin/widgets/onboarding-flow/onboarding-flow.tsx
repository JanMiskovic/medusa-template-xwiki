        ...
        async (
            ...
            switch (onboardingStep) {
                ...
                case "setup_finished":
                    ...
                    const orderId =
                        data?.orderId || searchParams.get("order_id");
                    if (orderId) {
                        return (await client.admin.orders.retrieve(orderId))
                            .order;
                    }
                ...
                case "preview_product":
                    ...
                    const productId =
                        data?.productId || searchParams.get("product_id");
                    if (productId) {
                        return (await client.admin.products.retrieve(productId))
                            .product;
                    }
        ...
        <>
            ...
            >
                ...
                >
                        ...
                        {!completed ? (
                            ...
                            <>
                                <div>
                                    ...
                                    <Text>
                                        This whole experience was built using
                                        our new <strong>widgets</strong>{" "}
                                        feature.
                                        <br /> You can find out more details and
                    ...
                    {
                        <div>
                            {(!completed ? steps : steps.slice(-1)).map(
                                (step) => {
