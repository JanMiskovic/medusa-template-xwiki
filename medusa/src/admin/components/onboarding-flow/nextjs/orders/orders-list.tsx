...
const OrdersListNextjs = ({ isComplete, data }: StepContentProps) => {
    ...
    const { mutateAsync: createCart, isLoading: cartIsLoading } =
        useCreateCart();
    ...
    return (
        <>
            <div className="mb-6 flex flex-col gap-2">
                <Text>
                    The last step is to create a sample order using one of your
                    products. You can then view your order’s details, process
                    its payment, fulfillment, inventory, and more.
                </Text>
                <Text>
                    You can use the button below to experience hand-first the
                    checkout flow in the Next.js storefront. After placing the
                    order in the storefront, you’ll be directed back here to
