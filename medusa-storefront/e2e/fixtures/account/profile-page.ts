...
export class ProfilePage extends AccountPage {
    ...
    constructor(page: Page) {
        ...
        this.accountNameEditor = this.container.getByTestId(
            "account-name-editor"
        );
        ...
        this.emailEditButton =
            this.accountEmailEditor.getByTestId("edit-button");
        this.phoneEditButton =
            this.accountPhoneEditor.getByTestId("edit-button");
        ...
        this.emailSaveButton =
            this.accountEmailEditor.getByTestId("save-button");
        this.phoneSaveButton =
            this.accountPhoneEditor.getByTestId("save-button");
        ...
        this.savedPassword =
            this.accountPasswordEditor.getByTestId("current-info");
        ...
        this.billingFirstNameInput = page.getByTestId(
