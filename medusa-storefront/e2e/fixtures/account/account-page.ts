...
export class AccountPage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.mobileAccountNav =
            this.container.getByTestId("mobile-account-nav");
        this.mobileAccountMainLink =
            this.mobileAccountNav.getByTestId("account-main-link");
        this.mobileOverviewLink =
            this.mobileAccountNav.getByTestId("overview-link");
        this.mobileProfileLink =
            this.mobileAccountNav.getByTestId("profile-link");
        this.mobileAddressesLink =
            this.mobileAccountNav.getByTestId("addresses-link");
        this.mobileOrdersLink =
            this.mobileAccountNav.getByTestId("orders-link");
        this.mobileLogoutLink =
            this.mobileAccountNav.getByTestId("logout-button");
    }
