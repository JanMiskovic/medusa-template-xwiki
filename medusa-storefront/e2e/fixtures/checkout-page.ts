...
export class CheckoutPage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.editAddressButton = this.container.getByTestId(
            "edit-address-button"
        );
        this.editDeliveryButton = this.container.getByTestId(
            "edit-delivery-button"
        );
        this.editPaymentButton = this.container.getByTestId(
            "edit-payment-button"
        );
        ...
        this.billingCityInput =
            this.container.getByTestId("billing-city-input");
        ...
        this.billingPhoneInput = this.container.getByTestId(
            "billing-phone-input"
        );
        this.billingPostalInput = this.container.getByTestId(
        ...
        this.shippingCityInput = this.container.getByTestId(
            "shipping-city-input"
        );
        this.shippingCompanyInput = this.container.getByTestId(
            "shipping-company-input"
        );
        this.shippingEmailInput = this.container.getByTestId(
        ...
        this.shippingPhoneInput = this.container.getByTestId(
        ...
        this.submitOrderButton = this.container.getByTestId(
            "submit-order-button"
        );
        ...
        this.itemOriginalPrice = this.container.getByTestId(
            "item-original-price"
        );
        this.itemReducedPrice =
            this.container.getByTestId("item-reduced-price");
